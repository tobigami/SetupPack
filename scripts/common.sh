...
show_usage() {
    ...
    echo "  tailscale    Install Tailscale VPN client"
    echo "  datagrip     Install JetBrains DataGrip IDE for databases"
    echo "  webstorm     Install JetBrains WebStorm IDE for web development"
    echo "  postman      Install Postman API client"
